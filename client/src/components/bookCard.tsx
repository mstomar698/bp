  ...
  return (
    <div className="border rounded-lg p-4 shadow-md max-w-[300px] h-min m-4">
      ...
      <div className="flex justify-between mt-4">
        <Link to={`/buybook/${book._id}`} title="buy" className="w-1/2">
          <button className="bg-green-300 hover:bg-green-500 hover:border-red-300 hover:border active:bg-green-500  text-black font-semibold py-2 px-4 rounded-l-lg rounde-r-none w-full flex flex-row items-center text-xl justify-around">
            <FaShoppingCart className="pt-0.5" /> Buy
          </button>
        </Link>
        <Link to={`/readbook/${book._id}`} title="read" className="w-1/2">
          <button className="bg-blue-300 hover:bg-blue-500 active:bg-blue-500 hover:border-red-300 hover:border text-black font-semibold py-2 px-4 rounded-r-lg rounded-l-none w-full flex flex-row items-center text-xl justify-around">
