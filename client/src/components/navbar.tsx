...
const Navbar = () => {
  ...
  return (
    <div>
      <header className="bg-black/10 border fixed w-full backdrop-blur-md z-50 border-green-300 focus:border-green-500 hover:border-green-500 rounded-b-lg">
        <nav className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div>
            ...
            {mobileMenu && (
              <div className="lg:hidden md:hidden h-screen w-full top-0 z-40 left-0 backdrop-blur-sm absolute bg-black text-green-300">
                <div>
                  {userInfo ? (
                      ...
                      <div className="border-2 shadow-white/50 shadow-lg m-4 rounded-lg p-4">
                        ...
                        <div className="text-white/80 w-full flex flex-row justify-center items-center shadow-2xl">
                          <Link
                            ...
                            className="block px-4 py-2 hover:bg-green-300 hover:text-red-500"
                          >
                            <span className="text-red-500 rounded-full p-1 text-xs border-2 border-red-400 px-2 mr-2 mb-1">
                ...
                <div className="relative mx-1 flex flex-row gap-8 text-xl">
                  ...
                  >
                    <Link to="/collection" className="">
                      <span className="text-red-500 rounded-full p-1 text-md font-bold absolute top-0 mb-2 ml-2">
                        {collections[userEmail].length}
                      </span>
                  ...
                  <button
                    type='button'
                    className="text-gray-300 hover:text-white focus:outline-none border border-green-300 px-4 rounded-lg p-1 shadow-lg backdrop-blur-lg flex flex-row"
                    onClick={handleUserMenuClick}
                  >
                  ...
                  {userMenu && (
                    <>
                      <div className="absolute right-0 mt-12 w-48 bg-white/80  border-2 border-green-300 rounded-md shadow-green-700 shadow-xl z-50 p-2">
